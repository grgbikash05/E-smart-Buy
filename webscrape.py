...
def test(search_query):
    query = [
        ...
        ['https://www.daraz.com.np/catalog/?q=' + search_query +'&_keyori=ss&from=input&spm=a2a0e.11779170.search.go.287d2d2bR6H8P6', '', 'daraz', ['div', 'c2prKC'], ['div', 'c16H9d'], ['span', 'c13VH6'], ['img', 'c1ZEkM ', 'src'], ['div', 'cRjKsc']],
    ]
        ...
        if len(containers) <= 5:
            for container in containers:
                ...
                if(q[2] == "muncha"):
                    ...
                    title_of_product = container.find(q[4][0], {"class" : q[4][1]}).text
